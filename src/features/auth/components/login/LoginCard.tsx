            ...
            <div className="bg-white dark:bg-card border border-[#767676] dark:border-border rounded-[30px] lg:rounded-[40px] p-6 sm:p-7 lg:p-8 w-full max-w-[520px] mx-auto lg:mx-0 shadow-lg dark:shadow-2xl animate-fade-in-up animation-delay-500">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2 animate-fade-in-up animation-delay-600">
                  <label className="block font-nunito text-xl text-[#272727] dark:text-foreground">
                    Email
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full h-[50px] pl-11 pr-4 border border-[#696969] dark:border-border rounded-[14px] bg-white dark:bg-input font-nunito text-lg text-foreground focus:outline-none focus:ring-2 focus:ring-[#008ACF] dark:focus:ring-primary focus:border-transparent transition-all"
                      required
                      disabled={isLoading}
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between pt-3 pb-1 space-y-3 sm:space-y-0 animate-fade-in-up animation-delay-800">
                  <div className="flex items-center space-x-2">
                    <div className="relative">
                      ...
                      >
                        ...
                        <span className="font-nunito-sans text-base text-[#333] dark:text-foreground">
                          Remember me
                        </span>
                      </label>
                    </div>
                  ...
                  <div className="text-left sm:text-right">
                    <Link
                      ...
                      className="font-nunito text-base text-[#008ACF] dark:text-primary underline hover:text-[#0f73a5] dark:hover:text-primary/80 transition-colors inline-block"
                ...
                <div className="pt-6 animate-fade-in-up animation-delay-900">
                  <button
                    type="submit"
                    className="w-full max-w-[200px] h-16 bg-[#008ACF] dark:bg-primary text-white dark:text-primary-foreground font-nunito-sans text-[18px] rounded-xl hover:bg-[#0f73a5] dark:hover:bg-primary/90 transition-all duration-200 mx-auto disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center shadow-lg hover:shadow-xl transform hover:scale-105"
                    disabled={isLoading}
                  >
                    {isLoading ? (
                      <>
